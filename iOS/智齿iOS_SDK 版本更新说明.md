...
**标准版：**[<智齿iOS_SDK_3.3.3>](https://img.sobot.com/mobile/sdk/iOS_SDK_3.3.3.zip)

**电商版：**[<智齿iOS_SDK_3.3.0电商版>](https://img.sobot.com/mobile/sdk/iOS_SDK_3.3.0_MALL.zip)
...
2.【新增】 隐私策略 PrivacyInfo.xcprivacy

3.【优化】 荷兰语："点击重新连接" = "Klik om opnieuw verbinding te maken";改为"重新加载" = "Herladen";   

4.【优化】iOS “是否解决了您的问题？”英文翻译不准确问题   

    "是否解决了您的问题？" = "Has your problem been solved?";

5.【优化】iOS 17 留言有更新，没有跳转到留言页面 
...
2.【优化】统一权限提示框按钮说明，原有“好的”改为“取消”


## ## SDK 3.2.8 版本更新说明[2024-02-01]

1. 【新增】 多轮模版样式一支持多行展示

2.【新增】 新建留言页面支持是否展示问题描述和问题描述是否必填 
...
## ## SDK 3.2.3 版本更新说明[2023-07-27]

1、【新增】增加客户调用离线接口的相关日志

2、【优化】修改会话结束提示语



## ## SDK 3.2.2 版本更新说明[2023-06-30]
...
6、【优化】优化多伦回复，踩和赞显示在底部是UI高度问题

## 

## ## SDK 3.2.1 版本更新说明[2023-05-25]
...
## ## SDK 3.2.0 版本更新说明[2023-03-24]

1、【新增】新增人工欢迎语显示规则（按用户首次咨询、单个会话、每次都显示）

2、【优化】接口语言，如果未指定跟随客户端配置语言

3、【优化】多语言UI适配方案开发. 

## 

## ## SDK 3.1.9 版本更新说明[2023-02-10]
...
1.【新增】机器人点踩按钮支持在消息体右侧和底部显示


## ## SDK 3.1.6 版本更新说明[2022-10-20]

1.【优化】 阿拉伯语 “感谢您的评价” 提示文案的显示问题
...
3.【优化】优化会话保持状态下，再次进入SDK聊天页面高度异常问题
...
1、留言页面首次进入，顶部导航文字没有高亮效果

2、留言成功，点击前往留言记录，顶部导航UI没有切换
...
7、新增IM端口切换轮询日志实时监控，方便客户反馈客服无应答时查看客户端状态
...
2、优化自动补全功能导致页面提前销毁问题,可能引起未读消息不计数问题 
...
3、优化多语言适配，"留言"  翻译有空格时，无法正常识别

4、优化电商版本显示商户列表隐藏导航会空白bug
...
9、修改腾讯云域名为[www.soboten.com](http://www.soboten.com)  
...
2、【优化】初始化未说话返回，超时以后重新初始化

3、支持客户下载语言包，指定SDK语言

4、支持客户控制是否显示会话时间

5、暂不评价逻辑优化，与Android统一交互

6、【优化】显示评价页面卡顿问题

7、【优化】特殊情况键盘遮挡输入框问题

8、【bug】发送相册、文件等影响页面数据刷新问题

9、【bug】优化获取相册权限问题，个别机型不允许访问相册时无提醒问题

10、【bug】拍照发送特别情况没有反应问题
...
14、【优化】支持用户退出会话时触发弹出评价后不评价离开会话，显示"暂不评价"  
